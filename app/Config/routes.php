 ...
 */
	...
	Router::connect('/home', array('controller' => 'settings', 'action' => 'home'));
	Router::connect('/publication', array('controller' => 'settings', 'action' => 'publication'));
	Router::connect('/research', array('controller' => 'settings', 'action' => 'research'));
